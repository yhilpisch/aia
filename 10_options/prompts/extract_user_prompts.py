...
Supports session JSON where prompts are under 'items' or provided as a top-level list.
...
def extract_prompts(input_path):
    with open(input_path, 'r', encoding='utf-8') as f:
        session = json.load(f)
    # Support session JSON as dict with 'items' or as a list of items directly.
